...
export const metadataServiceProvider: FactoryProvider<IMetadataService> = {
  ...
  inject: [HttpService, ERC721_VALIDATOR_TOKEN],
  useFactory: (httpService: HttpService, erc721Validator: IERC721Validator) => {
    return new NftportMetadataService(httpService, erc721Validator);
  },
};
