...
const AllTrades: React.FC = () => {
  ...
  const [selectedCollection, setSelectedCollection] = useState<INft[] | null>(null)
  ...
  return (
    <>
      <TradesLayout onSearchChange={setSearch}>
        ...
        <TradeList /*list={trades}*/ list={[]} onClick={handleClickItem} onClickCollection={handleClickCollection} />
      </TradesLayout>
